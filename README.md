...
3. Download `MenaceMenuV1.2.1pre.dll` and its dependencies JSON from the [MenaceMenu repository](https://github.com/soci-ety/MenaceMenu), or build them from source below.
...
```text
src\bin\Debug\net6.0\MenaceMenuV1.2.1pre.dll
src\bin\Debug\net6.0\MenaceMenuV1.2.1pre.deps.json
```
